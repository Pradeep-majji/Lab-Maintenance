...
<head>
        ...
        <link rel="stylesheet" href="newcolor.css">
    </head>
    <body>
<?php
...
<button name="HOME" value="HOME" style="background:#1a8ac3; height:40px;width:200px;font-size:20px; color:white; cursor:pointer; border-radius:5px; margin-left:100px; margin-top:40px;" onclick="window.location.href='button.html'">HOME</button>
</div><form action="pcstatus.php" method="POST">
<?php if(isset($_GET['error'])){?>
    <p class="error" style=" margin-top:20px;color:black; margin-left:560px; font-size:30px;"><?php echo $_GET['error'];?></p>
    <?php } ?>
<main></main>
